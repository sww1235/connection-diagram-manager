...
use crate::datatypes::{svg::Svg, unit_helper::length::Length, util_types::Catalog};

/// `MountingRailType` is the source code representation of the on-disk file format for an in-memory
/// [`MountingRailType`](crate::datatypes::library_types::mounting_rail_type::MountingRailType).

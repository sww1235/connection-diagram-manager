...
use cdm_traits::{
    compare::Compare, compare::CompareResult, empty::Empty, partial_empty::PartialEmpty,
};
...
#[derive(Debug, Default, PartialEq, Compare)]
...
// Can't derive since the derive implementation is only for structs at this point
// TODO: Fix this
impl Compare for WireCable {
    fn compare(
        &self,
        other: &Self,
